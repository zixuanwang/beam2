...
vad_folder = 'simple_vad'
device_list = ['Dell_Laptop', 'Headset_Microsoft',
'Headset_Plantronics', 'Kinect_V1', 'Tablet_Surface_Pro', 
'Main_Laptop_Mic', 'Webcam_LifeCam_5000', 'Phone_Htc_8x', 'Webcam_LifeCam_Studio',
'Phone_Lumia_1520', 'Webcam_Logitech_C920']
